...
import { BottomTabParamList, TabOneParamList, TabTwoParamList, TabUploadParamList } from "../types";
...
const TabUploadStack = createStackNavigator<TabUploadParamList>();

export const TabUploadNavigator = () => {
  return (
    <TabUploadStack.Navigator>
      <TabUploadStack.Screen name="TabUploadScreen" component={TabUploadScreen} options={{ headerTitle: "Upload" }} />
    </TabUploadStack.Navigator>
  );
};
