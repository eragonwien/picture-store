...
docker run --name=picturestorewebapi-container --restart=always -p 5000:80 -v /home/pi/picture-store/upload_files:/upload_files -d eragonwien/picturestorewebapi
